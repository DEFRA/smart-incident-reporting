...
const handleSearchButtonClick = async () => {
  ...
  // No input
  if (!inputValue) {
    return setTimeout(() => showError('Enter a search term, for example a nearby town, city or postcode'), ERROR_DELAY_MS)
  }
...
const getSearchInputValue = () => {
  ...
  const aaValue = aaInput?.value?.trim()
  if (aaValue) {
    return aaValue
  }
