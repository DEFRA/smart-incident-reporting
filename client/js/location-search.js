...
const handleSearchButtonClick = async () => {
  ...
  if (autoCompleteValue) return panToOSValue(autoCompleteValue)
...
const getSearchInputValue = () => {
  ...
  if (aaInput && aaInput.value !== undefined) return aaInput.value.trim()
...
const hideError = () => {
  document.querySelector('.govuk-error-summary.map-desktop-only')?.remove()
  document.querySelector('.govuk-error-summary.map-mobile-only')?.remove()
