...
const handlers = {
  get: async (request, h) => {
    ...
    return h.view(constants.views.SMELL_EFFECT_ON_ACTIVITY, {
      ...getContext(),
      onGoing
    })
  },
  post: async (request, h) => {
    request.yar.set(constants.redisKeys.SMELL_EFFECT_ON_ACTIVITY, buildAnswers(request.payload))
...
export default [
  {
    method: 'GET',
    path: constants.routes.SMELL_EFFECT_ON_ACTIVITY,
