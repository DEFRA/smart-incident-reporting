...
const getContext = request => {
  const locationOption = request.yar.get(constants.redisKeys.ILLEGAL_FISHING_LOCATION_OPTION)
  const showCurrentLocation = locationOption?.[0]?.answerId === questionSets.ILLEGAL_FISHING.questions.ILLEGAL_FISHING_LOCATION_OPTION.answers.gps.answerId
