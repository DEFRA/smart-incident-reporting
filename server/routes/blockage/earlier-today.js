...
const handlers = {
  get: async (request, h) => {
    return h.view(constants.views.BLOCKAGE_EARLIER_TODAY, {
      ...getContext(request)
    })
  },
...
const getContext = request => {
  const time = request.yar.get(constants.redisKeys.BLOCKAGE_EARLIER_TODAY)
  return {
    time
  }
}
...
export default [
  {
    method: 'GET',
    path: constants.routes.BLOCKAGE_EARLIER_TODAY,
