...
describe(url, () => {
  ...
  describe('POST', () => {
    ...
    it('Sad: sewage, chemical and Something else option is selected and no somethingelse details added ', async () => {
      const answerId = [question.answers.somethingElse.answerId.toString(), question.answers.sewage.answerId.toString(), question.answers.chemical.answerId]
      const somethingElseDetails = ''
      const options = {
        url,
        payload: {
