      ...
      expect.objectContaining({
        reportingAnEnvironmentalProblem: expect.objectContaining({
          ...
          data: expect.arrayContaining([
            ...
            expect.objectContaining({ questionId: 110, questionAsked: 'What\'s blocking the river?', questionResponse: true, answerId: 111 }),
            ...
            expect.objectContaining({ questionId: 180, questionAsked: 'Do you know who is responsible for causing the blockage?', questionResponse: true, answerId: 181 }),
            expect.objectContaining({ questionId: 180, questionAsked: 'Do you know who is responsible for causing the blockage?', questionResponse: true, answerId: 183, otherDetails: 'Local construction company' })
          ])
        })
      }))
    })
