...
const url = constants.routes.BLOCKAGE_IMAGES_OR_VIDEO
...
describe(url, () => {
  describe('GET', () => {
    it(`Should return success response and correct view for ${url}`, async () => {
      const response = await submitGetRequest({ url }, question.text, constants.statusCodes.OK, sessionDataWithEmail)
    ...
    it(`Should return success response and correct view for ${url} with email text field`, async () => {
      const response = await submitGetRequest({ url }, question.text, constants.statusCodes.OK, sessionDataWithoutEmail)
    ...
    it(`Should return success response and correct view for ${url} with pre selected yes option`, async () => {
      const response = await submitGetRequest({ url }, question.text, constants.statusCodes.OK, sessionDataYes)
      expect(response.payload).toContain('We\'ll send a message to <strong>test@test.com</strong> with details on where to send these, if needed.')
