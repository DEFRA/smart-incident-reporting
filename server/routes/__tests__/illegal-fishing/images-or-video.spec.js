...
describe(url, () => {
  ...
  describe('POST', () => {
    it('Happy: Should accept yes option with prefilled data and redirect to ILLEGAL_FISHING_OTHER_INFORMATION', async () => {
    ...
    it('Happy: Should accept yes option with text input data and redirect to ILLEGAL_FISHING_OTHER_INFORMATION', async () => {
      const answerId = question.answers.yes.answerId
      const options = {
        url,
        payload: {
    ...
    it('Happy: Should accept no option with email data and redirect to ILLEGAL_FISHING_OTHER_INFORMATION', async () => {
    ...
    it('Happy: Should accept no option without email data and redirect to ILLEGAL_FISHING_OTHER_INFORMATION', async () => {
      const answerId = question.answers.no.answerId
      const options = {
        url,
        payload: {
