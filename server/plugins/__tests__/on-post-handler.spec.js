...
describe('onPostHandler', () => {
  describe('Cache-control header', () => {
    it('should set cache-control header on GET responses', async () => {
      const response = await submitGetRequest({ url: constants.routes.SMELL_SOURCE }, null, constants.statusCodes.OK)
