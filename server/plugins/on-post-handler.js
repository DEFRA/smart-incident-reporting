...
const smellPrerequisites = Object.fromEntries([
  ...
  [k.SMELL_EFFECT_ON_HEALTH, [r.SMELL_MEDICAL_HELP, r.SMELL_IMAGES_OR_VIDEO]],
  [k.SMELL_MEDICAL_HELP, [r.SMELL_IMAGES_OR_VIDEO]],
  [k.SMELL_IMAGES_OR_VIDEO, [r.SMELL_CONTACT_DETAILS]],
  [k.SMELL_CONTACT_DETAILS, [r.SMELL_OTHER_INFORMATION]]
...
const smellKeyToRoute = {
  ...
  [k.SMELL_MEDICAL_HELP]: r.SMELL_MEDICAL_HELP,
...
const getSmellJourneyRedirect = (request) => {
  ...
  if (!path.startsWith('/smell/') || path === r.SMELL_HEALTH) {
    return null
  }
